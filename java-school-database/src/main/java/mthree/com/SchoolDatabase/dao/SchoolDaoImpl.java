...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<TeacherCount> teacherCountByDept() {
        ...
        String sql = "SELECT dept, COUNT(*) AS teacherCount FROM teacher GROUP BY dept ORDER BY dept";
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT c.courseCode, c.courseDesc, COUNT(cs.student_id) AS numStudents FROM course c JOIN course_student cs ON c.cid = cs.course_id GROUP BY c.cid, c.courseCode, c.courseDesc ORDER BY c.courseCode";
